...
#include "../../../../../../src/modules/Ubuntu/Components/plugin/ucunits.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_UCUnits_t, stringdata) + ofs \
...
void UCUnits::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UCUnits *_t = static_cast<UCUnits *>(_o);
        switch (_id) {
        ...
        {
            typedef void (UCUnits::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UCUnits::gridUnitChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject UCUnits::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UCUnits.data,
      qt_meta_data_UCUnits,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UCUnits.stringdata))
        return static_cast<void*>(const_cast< UCUnits*>(this));
...
int UCUnits::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< float*>(_v) = gridUnit(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setGridUnit(*reinterpret_cast< float*>(_v)); break;
        }
        _id -= 1;
